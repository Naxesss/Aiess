...
<div class="page-extra-tabs">
	<div class="osu-page osu-page--small">
		<ul class="page-mode page-mode--page-extra-tabs">
			...
			<li class="page-mode__item">
				<a class="page-mode-link page-mode-link--is-active" href="https://osu.ppy.sh/beatmapsets/1111383/discussion/-/generalAll" data-mode="generalAll">
					<div>General 
						<span class="page-mode-link__subtitle">(All difficulties)</span>
					</div>
					<span class="page-mode-link__badge">22</span>
...
soup2: BeautifulSoup = soupify(HTML2)
tag2: Tag = soup2.find("div", {"class": "mock-event"})